...
local WeaponDataBase = {
	{
		ID = 1,
		WeaponName = "Default",
		Description = "Gloves made out of hardened metal.",
		Rarity = 1,
		LevelReq = 1,
		MaxUpgrades = 3,
		MaxEnchantments = 2,
		SellPrice = 200,
		Model = game.ReplicatedStorage.Models.Weapons.NatsukoWeapon,
		Skills = { --up to 5
		},
		Stats = {
			HP = 0,
	...
	{
		ID = 3,
		WeaponName = "Crystalized Shackle",
		Description = "Gloves made out of hardened metal.",
		Rarity = 2,
		LevelReq = 5,
		MaxUpgrades = 2,
	...
	{
		ID = 4,
		WeaponName = "Destructive Gauntlet",
		Description = "Gloves made out of hardened metal.",
		Rarity = 1,
		LevelReq = 15,
		MaxUpgrades = 2,
	...
	{
		ID = 7,
		WeaponName = "Disputed Misfortune",
		Description = "Gloves made out of hardened metal.",
		Rarity = 3,
		LevelReq = 20,
		MaxUpgrades = 3,
