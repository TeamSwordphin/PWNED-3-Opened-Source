...
local WeaponDataBase = {
	{
		ID = 1,
		WeaponName = "Default",
		Description = "A spear made out of unknown materials.",
		Rarity = 1,
		LevelReq = 1,
		MaxUpgrades = 3,
		MaxEnchantments = 2,
		SellPrice = 200,
		Model = game.ReplicatedStorage.Models.Weapons.LingeringForceWeapon,
		Skills = { --up to 5
		},
		Stats = {
			HP = 0,
